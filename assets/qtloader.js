...
function QtLoader(config) {
    ...
    if (config.containerElements !== undefined) {
        ...
        config.showLoader =
            ...
            function(loadingState, container) {
                ...
                loadingText.innerHTML =
                    "<p><center> ${loadingState}...</center><p>";
                return loadingText;
            };
        ...
        config.showExit =
            ...
            function(crashed, exitCode, container) {
                ...
                var symbolIndex = Math.floor(
                    Math.random() * crashSymbols.length
                );
    ...
    function loadEmscriptenModule(applicationName) {
        ...
        var emscriptenModuleSourcePromise = fetchText(
            applicationName + ".js"
        ...
        var wasmModulePromise = fetchCompileWasm(
            applicationName + ".wasm"
    ...
    function setLoaderContent() {
        ...
        for (container of config.containerElements) {
            var loaderElement = config.showLoader(
                self.loaderSubState,
                container
            );
